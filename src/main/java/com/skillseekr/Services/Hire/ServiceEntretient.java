...
public class ServiceEntretient implements IServices<Entretient> {
    ...
    public void add(Entretient entretient) throws SQLException {
        ...
        insertEntretientStatement.setDate(1, entretient.getDate());
    ...
    public void update(Entretient entretient) throws SQLException {
        String query = "UPDATE entretient SET date=?, type=?, resultat=?, id_rec_id=? WHERE id=?";
        try (PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            preparedStatement.setDate(1, entretient.getDate());
            ...
            preparedStatement.setInt(5, entretient.getId());
    ...
    public void delete(Entretient entretient) throws SQLException {
        String query = "DELETE FROM entretient WHERE id = ?";
